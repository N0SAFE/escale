...
export default function Layout({
    ...
    return (
        <div className="grid min-h-screen w-full lg:grid-cols-[280px_1fr]">
            <div
                className={cn(
                    '-translate-x-full absolute border-r bg-gray-100/40 lg:block dark:bg-gray-800/40 lg:relative transition-transform lg:translate-x-0',
                    isOpen
                        ? 'translate-x-0 block bg-white z-10 h-full w-[min-content] lg:w-[inherit]'
                        : ''
                )}
            >
