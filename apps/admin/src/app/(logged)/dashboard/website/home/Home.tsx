...
import { createImage, deleteImage, getImages } from '@/actions/Image'
...
export default function HomeWebsitePage() {
    ...
    return (
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
            <div className="mx-auto flex w-full max-w-[59rem] flex-1 flex-col gap-4">
                        ...
                        <Card x-chunk="dashboard-07-chunk-3">
                            ...
                            <CardContent>
                                <div className="grid gap-6">
                                    ...
                                    <div className="grid gap-3">
                                        <Card>
                                            <CardContent className="flex max-h-[300px] flex-col gap-3 overflow-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-secondary ">
                                                <CardHeader>
