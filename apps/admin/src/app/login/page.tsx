...
export default function Login() {
    const loginMutation = useMutation({
        mutationFn: async (data: z.infer<typeof FormSchema>) => login(data.email, data.password),
        onError: (error) => {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit((data) => loginMutation.mutate(data))} className="w-1/2 bg-white p-12 flex flex-col justify-center gap-8">
                    ...
                    />
                    <Button disabled={loginMutation.isPending} type="submit" className="mb-4">
                        {loginMutation.isPending ? <Loader size="4" /> : "Sign In with Email"}
                    </Button>
