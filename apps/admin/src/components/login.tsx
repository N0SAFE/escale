...
export function Login({ onSubmit }: LoginProps) {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(handleSubmit)} className="w-1/2 bg-white p-12 flex flex-col justify-center gap-8">
                  <h2 className="text-4xl font-bold mb-6">Sign in to yout account</h2>
                    ...
                    />
                    <Button type="submit" className="mb-4">Sign In with Email</Button>
