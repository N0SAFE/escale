...
export type AvailabilityEditProps<T extends AvailabilityType> = {
    onChange?: (availability: T) => void
    defaultValues: T
    displayedRange?: {
        blue: {
            from: Date
...
export default function AvailabilityEdit<T extends AvailabilityType>({
    defaultValues,
                ...
                <Combobox
                    ...
                    value={
                        availabilityState.spa
                            ? spas?.find(
                                  (spa) => spa.id === availabilityState.spa.id
                              )
                            : undefined
                    }
                    onSelect={(spa) => {
