...
export const Faq = makeRoute('/faq', {
    ...defaultInfo,
    ...FaqRoute.Route,
})
export const Reglement = makeRoute('/reglement', {
    ...defaultInfo,
    ...ReglementRoute.Route,
})
export const Reservation = makeRoute('/reservation', {
    ...defaultInfo,
    ...ReservationRoute.Route,
})
export const Reservationidview = makeRoute('/reservation/[id]/(view)', {
    ...defaultInfo,
    ...ReservationidviewRoute.Route,
})
export const Reservationidconfirm = makeRoute('/reservation/[id]/confirm', {
    ...defaultInfo,
